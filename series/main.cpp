...
int main(int argc, char *argv[]) {
	...
	std::cout << "Coloring finished [" << std::chrono::duration_cast<duration<double>>(end - begin).count() << " s]" << std::endl
	...
	std::cout << "Coloring accuracy: " << accuracy << "%" << std::endl << "Total time: "
		<< std::chrono::duration_cast<std::chrono::milliseconds>(end - initial).count() << " s" << std::endl;
